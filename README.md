...
An Application that is able to load data from a server and display the associated content using compose and Hilt based on modern Android tech-stacks and MVVM architecture.
...
- [X] Show content on scrollable list
